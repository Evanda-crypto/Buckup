    ...
    ?> Records]</strong></center>
      ...
      <th class="th-sm">Reason
                        ...
                        ?>
                                <tr>
                                <th>
                                    <button class="btn btn-warning" ><a href="restore.php?client-id=<?php echo $row['ClientID']; ?> " onClick="return confirm('Sure to restore <?php  echo $row['ClientName']; ?> as pap client  again?')">Restore</a></button>
                                    </th>
