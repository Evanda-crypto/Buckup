  ...
  <aside id="left-panel" class="left-panel">
    ...
    ?> Records]</strong></center>
      ...
      <th class="th-sm">Building Name
                        ...
                        ?>
                                <tr>
                                    <td><a href="javascript:void(0);" data-href="getturnedon.php?id=<?php echo $row['ClientID']; ?>" class="openPopup"><?php echo $row['DateTurnedOn']; ?></a></td>
                                    <td><a href="javascript:void(0);" data-href="getturnedon.php?id=<?php echo $row['ClientID']; ?>" class="openPopup"><?php echo $row['DateSigned']; ?></a></td>
                                    <td><a href="javascript:void(0);" data-href="getturnedon.php?id=<?php echo $row['ClientID']; ?>" class="openPopup"><?php echo $row['ClientName']; ?></a></td>
                                    <td><a href="javascript:void(0);" data-href="getturnedon.php?id=<?php echo $row['ClientID']; ?>" class="openPopup"><?php echo $row['ClientContact']; ?></a></td>
                                    <td><a href="javascript:void(0);" data-href="getturnedon.php?id=<?php echo $row['ClientID']; ?>" class="openPopup"><?php echo $row['BuildingName']; ?></a></td>
                                </tr>
                        <?php
