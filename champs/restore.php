                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center">Restore</h3>
                                        </div>
                                        <hr>
                                        <form  method="post" >
                                        <div class="row">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="input-group">
                                                        <input id="x_card_code"  readonly type="text" class="form-control cc-cvc" value="<?php echo $bcode?>" placeholder="Building Code" data-val="true" data-val-required="Please enter the security code" data-val-cc-cvc="Please enter a valid security code" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Client ID</label>
                                                <input id="cc-payment"   type="text" class="form-control" aria-required="true" value="<?php echo $clid?>" aria-invalid="false" readonly>
                                            </div>

                                            <div class="form-group">
                                                <label for="cc-number" class="control-label mb-1">Region</label>
                                                <input id="cc-number"  readonly type="text" class="form-control cc-number identified visa" value="<?php echo $reg?>" value="" data-val="true" data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number">
                                            ...
                                            <div>
                                                <button id="payment-button" type="submit" name="submit" class="btn btn-warning">
                                                    <span id="payment-button-amount">Restore</span>
